...
entity embsys_signal_generator_0_0_func_gen is
  port (
    ...
    \signal_data[6]_i_2_0\ : in STD_LOGIC_VECTOR ( 15 downto 0 );
...
architecture STRUCTURE of embsys_signal_generator_0_0_func_gen is
  ...
  signal \set_freq[31]_i_14_n_0\ : STD_LOGIC;
  signal \set_freq[31]_i_15_n_0\ : STD_LOGIC;
  ...
  signal signal_data1_carry_n_0 : STD_LOGIC;
  ...
  signal \signal_data[6]_i_11_n_0\ : STD_LOGIC;
  signal \signal_data[6]_i_12_n_0\ : STD_LOGIC;
  signal \signal_data[6]_i_13_n_0\ : STD_LOGIC;
  signal \signal_data[6]_i_14_n_0\ : STD_LOGIC;
  signal \signal_data[6]_i_1_n_0\ : STD_LOGIC;
  signal \signal_data[6]_i_2_n_0\ : STD_LOGIC;
  signal \signal_data[6]_i_3_n_0\ : STD_LOGIC;
  signal \signal_data[6]_i_4_n_0\ : STD_LOGIC;
  signal \signal_data[6]_i_5_n_0\ : STD_LOGIC;
  signal \signal_data[6]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \duty_count[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \duty_count[3]_i_1\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \signal_data[6]_i_11\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \signal_data[6]_i_13\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \signal_data[6]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \signal_data[6]_i_8\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \signal_data[6]_i_9\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \signal_data[7]_i_4\ : label is "soft_lutpair4";
...
\set_freq[31]_i_11\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000002FFFFFFFF"
    )
        port map (
      I0 => \set_freq[31]_i_13_n_0\,
      I1 => set_freq(7),
      I2 => set_freq(6),
      I3 => set_freq(9),
      I4 => set_freq(8),
...
\set_freq[31]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FF45FFFFFFFFFFFF"
    )
        port map (
      I0 => set_freq(7),
      I1 => \set_freq[31]_i_14_n_0\,
      I2 => set_freq(6),
      I3 => \set_freq[31]_i_15_n_0\,
      I4 => set_freq(8),
      I5 => set_freq(9),
      O => \set_freq[31]_i_12_n_0\
    );
\set_freq[31]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"01FF"
    )
        port map (
...
\set_freq[31]_i_14\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => set_freq(1),
      I5 => set_freq(0),
      O => \set_freq[31]_i_14_n_0\
    );
\set_freq[31]_i_15\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\set_freq[31]_i_8\: unisim.vcomponents.LUT6
    generic map(
...
\signal_data[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \signal_data[6]_i_3_n_0\,
      I3 => \signal_data[7]_i_2_n_0\,
      I4 => signal_data(6),
      I5 => \signal_data[6]_i_4_n_0\,
...
\signal_data[6]_i_10\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \signal_data[6]_i_2_0\(13),
      I1 => \signal_data[6]_i_2_0\(5),
      I2 => pattern_bit(2),
      I3 => \signal_data[6]_i_2_0\(9),
      I4 => pattern_bit(3),
      I5 => \signal_data[6]_i_2_0\(1),
      O => \signal_data[6]_i_10_n_0\
    );
\signal_data[6]_i_11\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
      ...
      I1 => \set_sig_type_reg_n_0_[2]\,
      I2 => \set_sig_type_reg_n_0_[1]\,
      O => \signal_data[6]_i_11_n_0\
    );
\signal_data[6]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
      I0 => \signal_data[6]_i_2_0\(12),
      I1 => \signal_data[6]_i_2_0\(4),
      I2 => pattern_bit(2),
      I3 => \signal_data[6]_i_2_0\(8),
      I4 => pattern_bit(3),
      I5 => \signal_data[6]_i_2_0\(0),
      O => \signal_data[6]_i_12_n_0\
    );
\signal_data[6]_i_13\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      I0 => \signal_data[6]_i_2_0\(10),
      I1 => pattern_bit(3),
      I2 => \signal_data[6]_i_2_0\(2),
      O => \signal_data[6]_i_13_n_0\
    );
\signal_data[6]_i_14\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => pattern_bit(1),
      I1 => pattern_bit(2),
      O => \signal_data[6]_i_14_n_0\
    );
\signal_data[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFAAEA"
    )
        port map (
      I0 => \signal_data[6]_i_5_n_0\,
      I1 => \signal_data[6]_i_6_n_0\,
      I2 => pattern_bit(1),
      I3 => pattern_bit(2),
      I4 => \signal_data[6]_i_7_n_0\,
      I5 => \signal_data[6]_i_8_n_0\,
      O => \signal_data[6]_i_2_n_0\
    );
\signal_data[6]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00008800F0000000"
    )
        port map (
      I0 => \signal_data[6]_i_9_n_0\,
      I1 => pattern_bit(2),
      I2 => \signal_data[6]_i_10_n_0\,
      I3 => \addr1_carry__2_n_0\,
      I4 => pattern_bit(0),
      I5 => pattern_bit(1),
      O => \signal_data[6]_i_3_n_0\
    );
\signal_data[6]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFF707"
    )
        port map (
      ...
      I1 => signal_data(6),
      I2 => \set_sig_type_reg_n_0_[0]\,
      I3 => \signal_data1_carry__0_n_7\,
      I4 => \signal_data[6]_i_11_n_0\,
      O => \signal_data[6]_i_4_n_0\
    );
\signal_data[6]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0200FF00"
    )
        port map (
      I0 => \signal_data[6]_i_12_n_0\,
      I1 => pattern_bit(0),
      I2 => pattern_bit(1),
      I3 => \addr1_carry__2_n_0\,
      I4 => \set_sig_type_reg_n_0_[2]\,
...
\signal_data[6]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"B800FF00B8000000"
    )
        port map (
      I0 => \signal_data[6]_i_2_0\(11),
      I1 => pattern_bit(3),
      I2 => \signal_data[6]_i_2_0\(3),
      I3 => \addr1_carry__2_n_0\,
      I4 => pattern_bit(0),
      I5 => \signal_data[6]_i_13_n_0\,
...
\signal_data[6]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8080800000008000"
        ...
        port map (
      I0 => \signal_data[6]_i_14_n_0\,
      I1 => pattern_bit(0),
      I2 => \addr1_carry__2_n_0\,
      I3 => \signal_data[6]_i_2_0\(7),
      I4 => pattern_bit(3),
      I5 => \signal_data[6]_i_2_0\(15),
      O => \signal_data[6]_i_7_n_0\
    );
\signal_data[6]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E0"
    )
        port map (
...
\signal_data[6]_i_9\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      I0 => \signal_data[6]_i_2_0\(14),
      I1 => pattern_bit(3),
      I2 => \signal_data[6]_i_2_0\(6),
...
sig_inst: entity work.embsys_signal_generator_0_0_func_gen
     port map (
      ...
      \signal_data[6]_i_2_0\(15 downto 0) => slv_reg3(15 downto 0),

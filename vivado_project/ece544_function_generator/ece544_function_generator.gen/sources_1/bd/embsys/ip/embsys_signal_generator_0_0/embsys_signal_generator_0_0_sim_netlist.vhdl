...
entity embsys_signal_generator_0_0_func_gen is
  port (
    ...
    \set_sig_type_reg[2]_0\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of embsys_signal_generator_0_0_func_gen is
  ...
  signal addr_end : STD_LOGIC_VECTOR ( 6 downto 5 );
  signal \addr_end_reg_n_0_[5]\ : STD_LOGIC;
  signal \addr_end_reg_n_0_[6]\ : STD_LOGIC;
  signal addr_start : STD_LOGIC_VECTOR ( 6 to 6 );
  ...
  signal \signal_data_reg[6]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \addr[5]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \addr_end[5]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \addr_end[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \addr_start[6]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \duty_count[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \duty_count[4]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \duty_count[6]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \duty_count[7]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \duty_count[7]_i_3\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \set_freq[31]_i_6\ : label is "soft_lutpair7";
  attribute COMPARATOR_THRESHOLD of signal_data1_carry : label is 11;
  attribute SOFT_HLUTNM of \signal_data[6]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \signal_waveform[0]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \signal_waveform[1]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \signal_waveform[2]_INST_0\ : label is "soft_lutpair4";
begin
...
\addr[7]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00002888"
    )
        port map (
...
\signal_data_reg[6]_i_5\: unisim.vcomponents.MUXF7
     port map (
...
sig_inst: entity work.embsys_signal_generator_0_0_func_gen
     port map (
      ...
      \set_sig_type_reg[2]_0\(2 downto 0) => slv_reg2(2 downto 0),
